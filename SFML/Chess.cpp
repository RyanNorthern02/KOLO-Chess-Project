//This file holds all the logic code for each piece in the game plus creation of the board
...
void Board::printBoard() {
	...
	for (int i = 0; i < 8; i++)
	{
		...
		for (int j = 0; j < 8; j++)
		{
			...
			//Switch statement to show what the different chess pieces will look like initially
			switch (p)
			{
...
//Operation for which pieces turn it is 
bool Board::doMove() {
	using namespace std;
	string move;
	int x1, x2, y1, y2;
...
//All the logic operations for every piece
...
bool Board::makeMove(int x1, int y1, int x2, int y2) {
	...
	// Returns the operations of each piece and error messages if doesn't fit in the criteria 
	switch (src->getPiece())
	{
